...
<head>
    ...
    <title>Sign Up - Reservasi Maiway</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .register-wrapper { width: 100%; display: flex; justify-content: center; align-items: center; padding: 40px 20px; }
        .register-card { background: #ffffff; width: 100%; max-width: 586px; border-radius: 20px; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.1); padding: 50px 60px; display: flex; flex-direction: column; }
        .register-header { text-align: center; margin-bottom: 35px; }
        .register-title { font-size: 36px; font-weight: 600; color: #000; margin-bottom: 8px; }
        .register-subtitle { font-size: 16px; color: #AEACAC; font-weight: 500; }
        .form-group { margin-bottom: 20px; position: relative; }
        .form-group label { display: block; font-size: 16px; font-weight: 500; color: #000; margin-bottom: 10px; }
        .form-control { width: 100%; height: 55px; background: #F9F9F9; border: 1px solid #EAEAEA; border-radius: 10px; padding: 0 50px 0 16px; font-size: 15px; outline: none; }
        ...
        .terms-container { display: flex; align-items: center; gap: 10px; margin: 20px 0; }
        .terms-container input { width: 18px; height: 18px; accent-color: #B5C37C; cursor: pointer; }
        .btn-signup { width: 100%; height: 60px; background-color: #B5C37C; color: #fff; border: none; border-radius: 10px; font-size: 18px; font-weight: 600; cursor: pointer; transition: 0.3s; }
        .divider { width: 100%; display: flex; align-items: center; text-align: center; margin: 30px 0; color: #AEACAC; font-size: 14px; }
        ...
        .social-container { display: flex; gap: 20px; justify-content: center; margin-bottom: 30px; }
        ...
        .signin-text { font-size: 15px; color: #AEACAC; text-align: center; }
        .signin-text a { color: #B5C37C; text-decoration: none; font-weight: 600; }
        @media (max-width: 600px) { body, html { background-color: #fff; } .register-card { box-shadow: none; padding: 40px 25px; border-radius: 0; } }
    </style>
</head>
<body>
    <div class="register-wrapper">
        <div class="register-card">
            <div class="register-header">
                ...
                <p class="register-subtitle">Fill your details bellow, or register with social account</p>
            </div>
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <span class="password-toggle" onclick="togglePass('reg_pass')">
                        <svg id="eye-icon-reg_pass" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </span>
                </div>
                <div class="form-group">
                    <label>Confirm Password</label>
                    <input type="password" name="password_confirmation" id="reg_conf" class="form-control" required>
                    <span class="password-toggle" onclick="togglePass('reg_conf')">
                        <svg id="eye-icon-reg_conf" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </span>
                </div>
                <div class="terms-container">
                    <input type="checkbox" id="terms" name="terms" required>
                    <label for="terms" style="font-size: 14px;">Agree with <a href="#" style="color:#B5C37C; text-decoration:none; font-weight:600;">Terms & Conditions</a></label>
                </div>
